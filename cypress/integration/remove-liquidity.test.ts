describe('Remove Liquidity', () => {
  it('redirects', () => {
    cy.visit('/remove/0x13A6eF26c0129CCD41349C9D68CEe301fE80A686-0xF9bA5210F91D0474bd1e1DcDAeC4C58E359AaD85')
    cy.url().should(
      'contain',
      '/remove/0x13A6eF26c0129CCD41349C9D68CEe301fE80A686/0xF9bA5210F91D0474bd1e1DcDAeC4C58E359AaD85'
    )
  })
  ...
  it('does not crash if ETH is duplicated', () => {
    cy.visit('/remove/0x13A6eF26c0129CCD41349C9D68CEe301fE80A686-0x13A6eF26c0129CCD41349C9D68CEe301fE80A686')
    cy.get('#remove-liquidity-tokena-symbol').should('contain.text', 'WETH')
